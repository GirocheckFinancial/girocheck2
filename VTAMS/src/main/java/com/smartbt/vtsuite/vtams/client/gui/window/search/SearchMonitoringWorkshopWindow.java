/*
 ** File: SearchMonitoringWorkshopWindow.java
 **
...
import com.smartbt.vtsuite.vtams.client.gui.window.tab.MonitoringTab;
import com.smartgwt.client.widgets.Canvas;

/**
 * The Merchant Services Window
 *
 * @author Ariela Saavedra
 */
public class SearchMonitoringWorkshopWindow extends BaseSearchWindow {
    ...
    protected void selectActionExecuted(BaseTreeNode node) {
        ...
        switch ((EntityType) node.getAttributeAsObject("entityType")) {
            case CUSTOMER: {
                ...
                Canvas monitoringCanva = (new MonitoringTab(EntityType.CUSTOMER, node)).getPane();
                monitoringCanva.setMargin(5);
                vManagementLayout.addMember(monitoringCanva);
                break;
            }
            case MERCHANT: {
                ...
                //vManagementLayout.addMember(UtilsSmartGWTUtils.getLineSpace());
                Canvas monitoringCanva = (new MonitoringTab(EntityType.MERCHANT, node)).getPane();
                monitoringCanva.setMargin(5);
                vManagementLayout.addMember(monitoringCanva);
                break;
            }
            case TERMINAL: {
                ...
                //vManagementLayout.addMember(UtilsSmartGWTUtils.getLineSpace());
                Canvas monitoringCanva = (new MonitoringTab(EntityType.TERMINAL, node)).getPane();
                monitoringCanva.setMargin(5);
                vManagementLayout.addMember(monitoringCanva);
                break;
            }
