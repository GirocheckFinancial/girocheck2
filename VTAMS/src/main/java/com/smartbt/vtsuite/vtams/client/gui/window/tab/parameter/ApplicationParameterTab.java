...
import com.smartbt.vtsuite.vtams.client.gui.window.list.ApplicationParameterListGrid;
 ...
 */
public class ApplicationParameterTab extends BaseTab implements BaseInterface {

    private BaseFilterForm filterForm;
    private ApplicationParameterListGrid listGrid;
...
//                        || record == null || record.getAttributeAsBoolean("readOnly"));               
                filterForm.getUpdateButton().setDisabled(record.getAttributeAsBoolean("readOnly"));
                filterForm.getDeleteButton().setDisabled(record.getAttributeAsBoolean("readOnly"));
            }
