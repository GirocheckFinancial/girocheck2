/*
 ** File: BooleanListGridField.java
 **
...
public class BooleanListGridField extends ListGridField {
     ...
     */
    public BooleanListGridField(String name, String title, Boolean isHidden) {
        super(name, title);
     ...
     * @param isHidden Whether this item is hidden or not
     */
    public BooleanListGridField(String name, Boolean isHidden) {
