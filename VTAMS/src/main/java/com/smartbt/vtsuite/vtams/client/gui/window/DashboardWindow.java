 ...
 */
public class DashboardWindow extends BaseEntityTabSetWindow {
    ...
    public DashboardWindow() {
        super();
        DashboardEnviromentalTab dashboardEnviromentalTab = new DashboardEnviromentalTab();

        managementWindow.addTab(dashboardEnviromentalTab);
    }
}
