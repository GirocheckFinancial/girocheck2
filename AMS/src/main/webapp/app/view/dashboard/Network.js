                            ...
                            items: [
                                 {
                                    ...
                                    html: '<div class="inner"><span class="x-fa fa-user"></span><span class="dashboard-analytics-percentage"> 156 </span> Transactions Today</div>',
                                    padding: '15 10 10 0'
                                },
                                {
                                    xtype: 'component',
                                    flex: 1,
                                    cls: 'top-info-container',
                                    html: '<div class="inner"><span class="x-fa fa-pie-chart"></span><span class="dashboard-analytics-percentage"> 95% </span>Successful Transactions</div>',
                                    padding: '15 10 10 0'
                                } 
                            ]
                        },
