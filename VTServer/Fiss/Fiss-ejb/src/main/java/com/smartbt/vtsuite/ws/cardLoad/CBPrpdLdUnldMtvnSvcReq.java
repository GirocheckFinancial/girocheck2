 ...
 *                               &lt;simpleType>
 *                                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *                                   &lt;enumeration value="CBPrpdLdUnld"/>
 *                                 &lt;/restriction>
 *                               &lt;/simpleType>
 *                             &lt;/element>
 *                             &lt;element name="SvcVer">
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element ref="{mtvnCWCBPrpdLdUnldReqData}CBPrpdLdUnldReqData"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
...
@XmlRootElement(name = "CBPrpdLdUnldMtvnSvcReq", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
public class CBPrpdLdUnldMtvnSvcReq {

    @XmlElement(name = "MtvnSvcVer", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
    protected String mtvnSvcVer;
    @XmlElement(name = "MsgUUID", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
    protected String msgUUID;
    @XmlElement(name = "PrcsParms", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
    protected CBPrpdLdUnldMtvnSvcReq.PrcsParms prcsParms;
    @XmlElement(name = "Svc", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
    protected List<CBPrpdLdUnldMtvnSvcReq.Svc> svc;
     ...
     * @return
     *     possible object is
     *     {@link CBPrpdLdUnldMtvnSvcReq.PrcsParms }
     *     
     */
    public CBPrpdLdUnldMtvnSvcReq.PrcsParms getPrcsParms() {
        return prcsParms;
    }
     ...
     *     
     */
    public void setPrcsParms(CBPrpdLdUnldMtvnSvcReq.PrcsParms value) {
     ...
     * {@link CBPrpdLdUnldMtvnSvcReq.Svc }
     * 
     * 
     */
    public List<CBPrpdLdUnldMtvnSvcReq.Svc> getSvc() {
        if (svc == null) {
            svc = new ArrayList<CBPrpdLdUnldMtvnSvcReq.Svc>();
        }
        return this.svc;
    }
    ...
    public static class PrcsParms {
        ...
        @XmlElement(name = "SrcID", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
        protected String srcID;
        @XmlElement(name = "TestInd", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
    ...
    public static class Svc {
        ...
        @XmlElement(name = "SvcParms", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
        protected CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms svcParms;
        @XmlElement(name = "Security", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
        protected CBPrpdLdUnldMtvnSvcReq.Svc.Security security;
        @XmlElement(name = "MsgData", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
        protected CBPrpdLdUnldMtvnSvcReq.Svc.MsgData msgData;
         ...
         * @return
         *     possible object is
         *     {@link CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms }
         *     
         */
        public CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms getSvcParms() {
            return svcParms;
        }
         ...
         *     
         */
        public void setSvcParms(CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms value) {
            this.svcParms = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CBPrpdLdUnldMtvnSvcReq.Svc.Security }
         *     
         */
        public CBPrpdLdUnldMtvnSvcReq.Svc.Security getSecurity() {
            return security;
        }
         ...
         *     
         */
        public void setSecurity(CBPrpdLdUnldMtvnSvcReq.Svc.Security value) {
            this.security = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CBPrpdLdUnldMtvnSvcReq.Svc.MsgData }
         *     
         */
        public CBPrpdLdUnldMtvnSvcReq.Svc.MsgData getMsgData() {
            return msgData;
        }
         ...
         *     
         */
        public void setMsgData(CBPrpdLdUnldMtvnSvcReq.Svc.MsgData value) {
            this.msgData = value;
        }
        ...
        public static class MsgData {
            ...
            @XmlElement(name = "CBPrpdLdUnldReqData", namespace = "mtvnCWCBPrpdLdUnldReqData", required = true)
            protected CBPrpdLdUnldReqData cbPrpdLdUnldReqData;

            /**
             * Gets the value of the cbPrpdLdUnldReqData property.
             * 
             * @return
             *     possible object is
             *     {@link CBPrpdLdUnldReqData }
             *     
             */
            public CBPrpdLdUnldReqData getCBPrpdLdUnldReqData() {
                return cbPrpdLdUnldReqData;
            }

            /**
             * Sets the value of the cbPrpdLdUnldReqData property.
             * 
             * @param value
             *     allowed object is
             *     {@link CBPrpdLdUnldReqData }
             *     
             */
            public void setCBPrpdLdUnldReqData(CBPrpdLdUnldReqData value) {
                this.cbPrpdLdUnldReqData = value;
            }
        ...
        public static class Security {
            ...
            @XmlElement(name = "NoAuth", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
            protected String noAuth;
            @XmlElement(name = "BasicAuth", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
            protected CBPrpdLdUnldMtvnSvcReq.Svc.Security.BasicAuth basicAuth;
            @XmlElement(name = "SessionAuth", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
            protected CBPrpdLdUnldMtvnSvcReq.Svc.Security.SessionAuth sessionAuth;
            @XmlElement(name = "SAMLAuth", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
            protected CBPrpdLdUnldMtvnSvcReq.Svc.Security.SAMLAuth samlAuth;
             ...
             * @return
             *     possible object is
             *     {@link CBPrpdLdUnldMtvnSvcReq.Svc.Security.BasicAuth }
             *     
             */
            public CBPrpdLdUnldMtvnSvcReq.Svc.Security.BasicAuth getBasicAuth() {
                return basicAuth;
            }
             ...
             *     
             */
            public void setBasicAuth(CBPrpdLdUnldMtvnSvcReq.Svc.Security.BasicAuth value) {
             ...
             * @return
             *     possible object is
             *     {@link CBPrpdLdUnldMtvnSvcReq.Svc.Security.SessionAuth }
             *     
             */
            public CBPrpdLdUnldMtvnSvcReq.Svc.Security.SessionAuth getSessionAuth() {
                return sessionAuth;
            }
             ...
             *     
             */
            public void setSessionAuth(CBPrpdLdUnldMtvnSvcReq.Svc.Security.SessionAuth value) {
             ...
             * @return
             *     possible object is
             *     {@link CBPrpdLdUnldMtvnSvcReq.Svc.Security.SAMLAuth }
             *     
             */
            public CBPrpdLdUnldMtvnSvcReq.Svc.Security.SAMLAuth getSAMLAuth() {
                return samlAuth;
            }
             ...
             *     
             */
            public void setSAMLAuth(CBPrpdLdUnldMtvnSvcReq.Svc.Security.SAMLAuth value) {
                this.samlAuth = value;
            }
            ...
            public static class BasicAuth {
                ...
                @XmlElement(name = "UsrID", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
                protected String usrID;
                @XmlElement(name = "Pwd", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
            ...
            public static class SAMLAuth {
                ...
                @XmlElement(name = "Assertion", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
            ...
            public static class SessionAuth {
                ...
                @XmlElement(name = "SessionID", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
                protected String sessionID;
                @XmlElement(name = "HttpSessionID", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
        ...
        public static class SvcParms {
            ...
            @XmlElement(name = "ApplID", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
            protected String applID;
            @XmlElement(name = "SvcID", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
            protected String svcID;
            @XmlElement(name = "SvcVer", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
            protected String svcVer;
            @XmlElement(name = "SvcNme", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
            protected String svcNme;
            @XmlElement(name = "RqstUUID", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
            protected String rqstUUID;
            @XmlElement(name = "RoutingID", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
            protected String routingID;
            @XmlElement(name = "Src", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
            protected CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src src;
             ...
             * @return
             *     possible object is
             *     {@link CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src }
             *     
             */
            public CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src getSrc() {
                return src;
            }
             ...
             *     
             */
            public void setSrc(CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src value) {
                this.src = value;
            }
            ...
            public static class Src {
                ...
                @XmlElement(name = "FieldList", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
                protected CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src.FieldList fieldList;
                @XmlElement(name = "GrpBusFunc", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
                protected String grpBusFunc;
                @XmlElement(name = "TranInfo", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
                protected String tranInfo;
                @XmlElement(name = "CustDefMsgSrc1", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
                protected String custDefMsgSrc1;
                @XmlElement(name = "CustDefMsgSrc2", namespace = "mtvnCWCBPrpdLdUnldSvcReq")
                 ...
                 * @return
                 *     possible object is
                 *     {@link CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src.FieldList }
                 *     
                 */
                public CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src.FieldList getFieldList() {
                    return fieldList;
                }
                 ...
                 *     
                 */
                public void setFieldList(CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src.FieldList value) {
                ...
                public static class FieldList {
                    ...
                    @XmlElement(name = "Field", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
                    protected List<CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field> field;
                     ...
                     * <p>
                     * Objects of the following type(s) are allowed in the list
                     * {@link CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field }
                     * 
                     * 
                     */
                    public List<CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field> getField() {
                        if (field == null) {
                            field = new ArrayList<CBPrpdLdUnldMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field>();
                        }
                        return this.field;
                    }
                    ...
                    public static class Field {
                        ...
                        @XmlElement(name = "FieldNme", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
                        protected String fieldNme;
                        @XmlElement(name = "FieldVal", namespace = "mtvnCWCBPrpdLdUnldSvcReq", required = true)
