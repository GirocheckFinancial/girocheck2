 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element ref="{mtvnCWCBPrpdAdjReqData}CBPrpdAdjReqData"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
...
@XmlRootElement(name = "CBPrpdAdjMtvnSvcReq", namespace = "mtvnCWCBPrpdAdjSvcReq")
public class CBPrpdAdjMtvnSvcReq {

    @XmlElement(name = "MtvnSvcVer", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
    protected String mtvnSvcVer;
    @XmlElement(name = "MsgUUID", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
    protected String msgUUID;
    @XmlElement(name = "PrcsParms", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
    protected CBPrpdAdjMtvnSvcReq.PrcsParms prcsParms;
    @XmlElement(name = "Svc", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
    protected List<CBPrpdAdjMtvnSvcReq.Svc> svc;
     ...
     * @return
     *     possible object is
     *     {@link CBPrpdAdjMtvnSvcReq.PrcsParms }
     *     
     */
    public CBPrpdAdjMtvnSvcReq.PrcsParms getPrcsParms() {
        return prcsParms;
    }
     ...
     *     
     */
    public void setPrcsParms(CBPrpdAdjMtvnSvcReq.PrcsParms value) {
     ...
     * {@link CBPrpdAdjMtvnSvcReq.Svc }
     * 
     * 
     */
    public List<CBPrpdAdjMtvnSvcReq.Svc> getSvc() {
        if (svc == null) {
            svc = new ArrayList<CBPrpdAdjMtvnSvcReq.Svc>();
        }
        return this.svc;
    }
    ...
    public static class PrcsParms {
        ...
        @XmlElement(name = "SrcID", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
        protected String srcID;
        @XmlElement(name = "TestInd", namespace = "mtvnCWCBPrpdAdjSvcReq")
    ...
    public static class Svc {
        ...
        @XmlElement(name = "SvcParms", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
        protected CBPrpdAdjMtvnSvcReq.Svc.SvcParms svcParms;
        @XmlElement(name = "Security", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
        protected CBPrpdAdjMtvnSvcReq.Svc.Security security;
        @XmlElement(name = "MsgData", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
        protected CBPrpdAdjMtvnSvcReq.Svc.MsgData msgData;
         ...
         * @return
         *     possible object is
         *     {@link CBPrpdAdjMtvnSvcReq.Svc.SvcParms }
         *     
         */
        public CBPrpdAdjMtvnSvcReq.Svc.SvcParms getSvcParms() {
            return svcParms;
        }
         ...
         *     
         */
        public void setSvcParms(CBPrpdAdjMtvnSvcReq.Svc.SvcParms value) {
            this.svcParms = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CBPrpdAdjMtvnSvcReq.Svc.Security }
         *     
         */
        public CBPrpdAdjMtvnSvcReq.Svc.Security getSecurity() {
            return security;
        }
         ...
         *     
         */
        public void setSecurity(CBPrpdAdjMtvnSvcReq.Svc.Security value) {
            this.security = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CBPrpdAdjMtvnSvcReq.Svc.MsgData }
         *     
         */
        public CBPrpdAdjMtvnSvcReq.Svc.MsgData getMsgData() {
            return msgData;
        }
         ...
         *     
         */
        public void setMsgData(CBPrpdAdjMtvnSvcReq.Svc.MsgData value) {
            this.msgData = value;
        }
        ...
        public static class MsgData {
            ...
            @XmlElement(name = "CBPrpdAdjReqData", required = true)
            protected CBPrpdAdjReqData cbPrpdAdjReqData;

            /**
             * Gets the value of the cbPrpdAdjReqData property.
             * 
             * @return
             *     possible object is
             *     {@link CBPrpdAdjReqData }
             *     
             */
            public CBPrpdAdjReqData getCBPrpdAdjReqData() {
                return cbPrpdAdjReqData;
            }

            /**
             * Sets the value of the cbPrpdAdjReqData property.
             * 
             * @param value
             *     allowed object is
             *     {@link CBPrpdAdjReqData }
             *     
             */
            public void setCBPrpdAdjReqData(CBPrpdAdjReqData value) {
                this.cbPrpdAdjReqData = value;
            }
        ...
        public static class Security {
            ...
            @XmlElement(name = "NoAuth", namespace = "mtvnCWCBPrpdAdjSvcReq")
            protected String noAuth;
            @XmlElement(name = "BasicAuth", namespace = "mtvnCWCBPrpdAdjSvcReq")
            protected CBPrpdAdjMtvnSvcReq.Svc.Security.BasicAuth basicAuth;
            @XmlElement(name = "SessionAuth", namespace = "mtvnCWCBPrpdAdjSvcReq")
            protected CBPrpdAdjMtvnSvcReq.Svc.Security.SessionAuth sessionAuth;
            @XmlElement(name = "SAMLAuth", namespace = "mtvnCWCBPrpdAdjSvcReq")
            protected CBPrpdAdjMtvnSvcReq.Svc.Security.SAMLAuth samlAuth;
             ...
             * @return
             *     possible object is
             *     {@link CBPrpdAdjMtvnSvcReq.Svc.Security.BasicAuth }
             *     
             */
            public CBPrpdAdjMtvnSvcReq.Svc.Security.BasicAuth getBasicAuth() {
                return basicAuth;
            }
             ...
             *     
             */
            public void setBasicAuth(CBPrpdAdjMtvnSvcReq.Svc.Security.BasicAuth value) {
             ...
             * @return
             *     possible object is
             *     {@link CBPrpdAdjMtvnSvcReq.Svc.Security.SessionAuth }
             *     
             */
            public CBPrpdAdjMtvnSvcReq.Svc.Security.SessionAuth getSessionAuth() {
                return sessionAuth;
            }
             ...
             *     
             */
            public void setSessionAuth(CBPrpdAdjMtvnSvcReq.Svc.Security.SessionAuth value) {
             ...
             * @return
             *     possible object is
             *     {@link CBPrpdAdjMtvnSvcReq.Svc.Security.SAMLAuth }
             *     
             */
            public CBPrpdAdjMtvnSvcReq.Svc.Security.SAMLAuth getSAMLAuth() {
                return samlAuth;
            }
             ...
             *     
             */
            public void setSAMLAuth(CBPrpdAdjMtvnSvcReq.Svc.Security.SAMLAuth value) {
                this.samlAuth = value;
            }
            ...
            public static class BasicAuth {
                ...
                @XmlElement(name = "UsrID", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
                protected String usrID;
                @XmlElement(name = "Pwd", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
            ...
            public static class SAMLAuth {
                ...
                @XmlElement(name = "Assertion", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
            ...
            public static class SessionAuth {
                ...
                @XmlElement(name = "SessionID", namespace = "mtvnCWCBPrpdAdjSvcReq")
                protected String sessionID;
                @XmlElement(name = "HttpSessionID", namespace = "mtvnCWCBPrpdAdjSvcReq")
        ...
        public static class SvcParms {
            ...
            @XmlElement(name = "ApplID", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
            protected String applID;
            @XmlElement(name = "SvcID", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
            protected String svcID;
            @XmlElement(name = "SvcVer", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
            protected String svcVer;
            @XmlElement(name = "SvcNme", namespace = "mtvnCWCBPrpdAdjSvcReq")
            protected String svcNme;
            @XmlElement(name = "RqstUUID", namespace = "mtvnCWCBPrpdAdjSvcReq")
            protected String rqstUUID;
            @XmlElement(name = "RoutingID", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
            protected String routingID;
            @XmlElement(name = "Src", namespace = "mtvnCWCBPrpdAdjSvcReq")
            protected CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src src;
             ...
             * @return
             *     possible object is
             *     {@link CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src }
             *     
             */
            public CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src getSrc() {
                return src;
            }
             ...
             *     
             */
            public void setSrc(CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src value) {
                this.src = value;
            }
            ...
            public static class Src {
                ...
                @XmlElement(name = "FieldList", namespace = "mtvnCWCBPrpdAdjSvcReq")
                protected CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src.FieldList fieldList;
                @XmlElement(name = "GrpBusFunc", namespace = "mtvnCWCBPrpdAdjSvcReq")
                protected String grpBusFunc;
                @XmlElement(name = "TranInfo", namespace = "mtvnCWCBPrpdAdjSvcReq")
                protected String tranInfo;
                @XmlElement(name = "CustDefMsgSrc1", namespace = "mtvnCWCBPrpdAdjSvcReq")
                protected String custDefMsgSrc1;
                @XmlElement(name = "CustDefMsgSrc2", namespace = "mtvnCWCBPrpdAdjSvcReq")
                 ...
                 * @return
                 *     possible object is
                 *     {@link CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src.FieldList }
                 *     
                 */
                public CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src.FieldList getFieldList() {
                    return fieldList;
                }
                 ...
                 *     
                 */
                public void setFieldList(CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src.FieldList value) {
                ...
                public static class FieldList {
                    ...
                    @XmlElement(name = "Field", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
                    protected List<CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field> field;
                     ...
                     * <p>
                     * Objects of the following type(s) are allowed in the list
                     * {@link CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field }
                     * 
                     * 
                     */
                    public List<CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field> getField() {
                        if (field == null) {
                            field = new ArrayList<CBPrpdAdjMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field>();
                        }
                        return this.field;
                    }
                    ...
                    public static class Field {
                        ...
                        @XmlElement(name = "FieldNme", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
                        protected String fieldNme;
                        @XmlElement(name = "FieldVal", namespace = "mtvnCWCBPrpdAdjSvcReq", required = true)
