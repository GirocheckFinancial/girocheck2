...
public class MockFissBusinessLogic {
    public static final String FISS_URL = System.getProperty("FISS_URL");
    
    private static MockFissBusinessLogic INSTANCE;
  

    public static synchronized MockFissBusinessLogic get() {
        if (INSTANCE == null) {
            INSTANCE = new MockFissBusinessLogic();
        }
        return INSTANCE;
    }
