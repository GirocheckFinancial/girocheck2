...
public class ChangePasswordReqBuilder {
    ...
    private static SZChgPwdMtvnSvcReq.PrcsParms buildPrcsParams(String space, Map<FissParam, String> map, StringBuilder sb) {
    ...
    private static SZChgPwdMtvnSvcReq.Svc buildSVC(String space, Map<FissParam, String> map, StringBuilder sb) {
        space = "   " + space;
    ...
    private static SZChgPwdMtvnSvcReq.Svc.SvcParms buildSvcParams(String space, Map<FissParam, String> map, StringBuilder sb) {
    ...
    private static SZChgPwdMtvnSvcReq.Svc.Security buildSecurity(String space, Map<FissParam, String> map, StringBuilder sb) {
    ...
    private static SZChgPwdMtvnSvcReq.Svc.MsgData buildMsgData(String space, Map<FissParam, String> map, StringBuilder sb) {
        ...
        sb.append(buildXML("MSG_DATA/REQUEST_DATA", map, space, NEW_PASSWORD));
