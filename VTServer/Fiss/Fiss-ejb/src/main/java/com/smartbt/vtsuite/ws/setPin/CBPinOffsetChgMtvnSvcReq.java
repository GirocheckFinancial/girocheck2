 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element ref="{mtvnCWCBPinOffsetChgReqData}CBPinOffsetChgReqData"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
...
@XmlRootElement(name = "CBPinOffsetChgMtvnSvcReq")
public class CBPinOffsetChgMtvnSvcReq {

    @XmlElement(name = "MtvnSvcVer", required = true)
    protected String mtvnSvcVer;
    @XmlElement(name = "MsgUUID", required = true)
    protected String msgUUID;
    @XmlElement(name = "PrcsParms", required = true)
    protected CBPinOffsetChgMtvnSvcReq.PrcsParms prcsParms;
    @XmlElement(name = "Svc", required = true)
    protected List<CBPinOffsetChgMtvnSvcReq.Svc> svc;
     ...
     * @return
     *     possible object is
     *     {@link CBPinOffsetChgMtvnSvcReq.PrcsParms }
     *     
     */
    public CBPinOffsetChgMtvnSvcReq.PrcsParms getPrcsParms() {
        return prcsParms;
    }
     ...
     *     
     */
    public void setPrcsParms(CBPinOffsetChgMtvnSvcReq.PrcsParms value) {
     ...
     * {@link CBPinOffsetChgMtvnSvcReq.Svc }
     * 
     * 
     */
    public List<CBPinOffsetChgMtvnSvcReq.Svc> getSvc() {
        if (svc == null) {
            svc = new ArrayList<CBPinOffsetChgMtvnSvcReq.Svc>();
        }
        return this.svc;
    }
    ...
    public static class Svc {
        ...
        @XmlElement(name = "SvcParms", required = true)
        protected CBPinOffsetChgMtvnSvcReq.Svc.SvcParms svcParms;
        @XmlElement(name = "Security", required = true)
        protected CBPinOffsetChgMtvnSvcReq.Svc.Security security;
        @XmlElement(name = "MsgData", required = true)
        protected CBPinOffsetChgMtvnSvcReq.Svc.MsgData msgData;
         ...
         * @return
         *     possible object is
         *     {@link CBPinOffsetChgMtvnSvcReq.Svc.SvcParms }
         *     
         */
        public CBPinOffsetChgMtvnSvcReq.Svc.SvcParms getSvcParms() {
            return svcParms;
        }
         ...
         *     
         */
        public void setSvcParms(CBPinOffsetChgMtvnSvcReq.Svc.SvcParms value) {
            this.svcParms = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CBPinOffsetChgMtvnSvcReq.Svc.Security }
         *     
         */
        public CBPinOffsetChgMtvnSvcReq.Svc.Security getSecurity() {
            return security;
        }
         ...
         *     
         */
        public void setSecurity(CBPinOffsetChgMtvnSvcReq.Svc.Security value) {
            this.security = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CBPinOffsetChgMtvnSvcReq.Svc.MsgData }
         *     
         */
        public CBPinOffsetChgMtvnSvcReq.Svc.MsgData getMsgData() {
            return msgData;
        }
         ...
         *     
         */
        public void setMsgData(CBPinOffsetChgMtvnSvcReq.Svc.MsgData value) {
            this.msgData = value;
        }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "", propOrder = {
            "cbPinOffsetChgReqData"
        })
        public static class MsgData {

            @XmlElement(name = "CBPinOffsetChgReqData", namespace = "mtvnCWCBPinOffsetChgReqData", required = true)
            protected CBPinOffsetChgReqData cbPinOffsetChgReqData;

            /**
             * Gets the value of the cbPinOffsetChgReqData property.
             * 
             * @return
             *     possible object is
             *     {@link CBPinOffsetChgReqData }
             *     
             */
            public CBPinOffsetChgReqData getCBPinOffsetChgReqData() {
                return cbPinOffsetChgReqData;
            }

            /**
             * Sets the value of the cbPinOffsetChgReqData property.
             * 
             * @param value
             *     allowed object is
             *     {@link CBPinOffsetChgReqData }
             *     
             */
            public void setCBPinOffsetChgReqData(CBPinOffsetChgReqData value) {
                this.cbPinOffsetChgReqData = value;
            }
        ...
        public static class Security {
            ...
            @XmlElement(name = "NoAuth")
            protected String noAuth;
            @XmlElement(name = "BasicAuth")
            protected CBPinOffsetChgMtvnSvcReq.Svc.Security.BasicAuth basicAuth;
            @XmlElement(name = "SessionAuth")
            protected CBPinOffsetChgMtvnSvcReq.Svc.Security.SessionAuth sessionAuth;
            @XmlElement(name = "SAMLAuth")
            protected CBPinOffsetChgMtvnSvcReq.Svc.Security.SAMLAuth samlAuth;
             ...
             * @return
             *     possible object is
             *     {@link CBPinOffsetChgMtvnSvcReq.Svc.Security.BasicAuth }
             *     
             */
            public CBPinOffsetChgMtvnSvcReq.Svc.Security.BasicAuth getBasicAuth() {
                return basicAuth;
            }
             ...
             *     
             */
            public void setBasicAuth(CBPinOffsetChgMtvnSvcReq.Svc.Security.BasicAuth value) {
             ...
             * @return
             *     possible object is
             *     {@link CBPinOffsetChgMtvnSvcReq.Svc.Security.SessionAuth }
             *     
             */
            public CBPinOffsetChgMtvnSvcReq.Svc.Security.SessionAuth getSessionAuth() {
                return sessionAuth;
            }
             ...
             *     
             */
            public void setSessionAuth(CBPinOffsetChgMtvnSvcReq.Svc.Security.SessionAuth value) {
             ...
             * @return
             *     possible object is
             *     {@link CBPinOffsetChgMtvnSvcReq.Svc.Security.SAMLAuth }
             *     
             */
            public CBPinOffsetChgMtvnSvcReq.Svc.Security.SAMLAuth getSAMLAuth() {
                return samlAuth;
            }
             ...
             *     
             */
            public void setSAMLAuth(CBPinOffsetChgMtvnSvcReq.Svc.Security.SAMLAuth value) {
                this.samlAuth = value;
            }
        ...
        public static class SvcParms {
            ...
            @XmlElement(name = "SvcVer", required = true)
            protected String svcVer;
            @XmlElement(name = "SvcNme")
            protected String svcNme;
            @XmlElement(name = "RqstUUID")
            protected String rqstUUID;
            @XmlElement(name = "RoutingID", required = true)
            protected String routingID;
            @XmlElement(name = "Src")
            protected CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src src;
             ...
             * @return
             *     possible object is
             *     {@link CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src }
             *     
             */
            public CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src getSrc() {
                return src;
            }
             ...
             *     
             */
            public void setSrc(CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src value) {
                this.src = value;
            }
            ...
            public static class Src {
                ...
                protected CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src.FieldList fieldList;
                @XmlElement(name = "GrpBusFunc")
                protected String grpBusFunc;
                @XmlElement(name = "TranInfo")
                protected String tranInfo;
                @XmlElement(name = "CustDefMsgSrc1")
                protected String custDefMsgSrc1;
                @XmlElement(name = "CustDefMsgSrc2")
                 ...
                 * @return
                 *     possible object is
                 *     {@link CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src.FieldList }
                 *     
                 */
                public CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src.FieldList getFieldList() {
                    return fieldList;
                }
                 ...
                 *     
                 */
                public void setFieldList(CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src.FieldList value) {
                ...
                public static class FieldList {
                    ...
                    protected List<CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field> field;
                     ...
                     * <p>
                     * Objects of the following type(s) are allowed in the list
                     * {@link CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field }
                     * 
                     * 
                     */
                    public List<CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field> getField() {
                        if (field == null) {
                            field = new ArrayList<CBPinOffsetChgMtvnSvcReq.Svc.SvcParms.Src.FieldList.Field>();
                        }
                        return this.field;
                    }
                    ...
                    public static class Field {
                        ...
                        @XmlElement(name = "FieldNme", required = true)
                        protected String fieldNme;
                        @XmlElement(name = "FieldVal", required = true)
