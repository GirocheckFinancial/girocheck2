...
import com.smartbt.vtsuite.manager.FissHostManager;
...
@MessageDriven( mappedName = ServerJNDI.HOST_IN_QUEUE_JNDI, activationConfig = {
    ...
    @ActivationConfigProperty( propertyName = "messageSelector", propertyValue = "hostName = 'FISS'" )
} )
@TransactionManagement( value = TransactionManagementType.BEAN )
public class FissMDB implements MessageListener {

//    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(FissMDB.class);
    ...
    public void onMessage( Message message ) {
        CustomeLogger.Output(CustomeLogger.OutputStates.Debug, "[FissMDB] Received Message",null);
        ...
        try {
             FissHostManager hostManager = FissHostManager.get();
            ...
            if (message instanceof ObjectMessage) {
                ...
                direxTransactionRequest = (DirexTransactionRequest) s;
                 ...
                 CustomeLogger.Output(CustomeLogger.OutputStates.Debug, "[FissMDB] correelation :: "+ direxTransactionRequest.getCorrelation(),null);
           ...
           CustomeLogger.Output(CustomeLogger.OutputStates.Debug, "[FissMDB] Sent Mesage to Core. " + direxTransactionRequest.getCorrelation(),null);
            ...
            try {
                ...
                jmsManager.send(direxTransactionResponse, jmsManager.getHostOutQueue(), direxTransactionRequest.getCorrelation());
                 ...
                 CustomeLogger.Output(CustomeLogger.OutputStates.Debug, "[FissMDB] Catch Excetion " + e.getMessage(),ex.getMessage());
            }
        }
