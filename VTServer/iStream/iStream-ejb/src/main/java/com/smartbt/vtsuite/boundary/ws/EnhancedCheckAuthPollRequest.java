...
/**
 * <p>Java class for enhancedCheckAuthPollRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="enhancedCheckAuthPollRequest">
 *   &lt;complexContent>
...
@XmlType(name = "enhancedCheckAuthPollRequest", propOrder = {
    "checkId",
    "entityId",
    "password",
    "user"
})
public class EnhancedCheckAuthPollRequest implements IBuilder{
    ...
    @Override
    public EnhancedCheckAuthPollRequest build(Map map) throws Exception {
        if(map.containsKey(ParameterName.CHECK_ID)){
          ...
          throw new Exception("CheckId required in the EnhancedCheckAuthPoll transaction.");
      }
