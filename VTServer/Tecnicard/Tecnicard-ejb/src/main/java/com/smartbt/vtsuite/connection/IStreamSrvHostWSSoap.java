...
public interface IStreamSrvHostWSSoap {
    ...
    @RequestWrapper(localName = "WMCardActivation", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardActivation")
    @ResponseWrapper(localName = "WMCardActivationResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardActivationResponse")
    ...
    @RequestWrapper(localName = "WMCardPersonalization", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardPersonalization")
    @ResponseWrapper(localName = "WMCardPersonalizationResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardPersonalizationResponse")
    ...
    @RequestWrapper(localName = "WMCardLoad", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardLoad")
    @ResponseWrapper(localName = "WMCardLoadResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardLoadResponse")
    ...
    @RequestWrapper(localName = "WMBalanceInquiry", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMBalanceInquiry")
    @ResponseWrapper(localName = "WMBalanceInquiryResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMBalanceInquiryResponse")
    ...
    @RequestWrapper(localName = "WMCardToBank", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardToBank")
    @ResponseWrapper(localName = "WMCardToBankResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardToBankResponse")
    ...
    @RequestWrapper(localName = "WMCardValidation", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardValidation")
    @ResponseWrapper(localName = "WMCardValidationResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardValidationResponse")
    ...
    @RequestWrapper(localName = "WMCardHolderValidation", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardHolderValidation")
    @ResponseWrapper(localName = "WMCardHolderValidationResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardHolderValidationResponse")
    ...
    @RequestWrapper(localName = "WMEcho", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMEcho")
    @ResponseWrapper(localName = "WMEchoResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMEchoResponse")
    ...
    @RequestWrapper(localName = "WMLastTransactions", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMLastTransactions")
    @ResponseWrapper(localName = "WMLastTransactionsResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMLastTransactionsResponse")
    ...
    @RequestWrapper(localName = "WMCashToCard", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCashToCard")
    @ResponseWrapper(localName = "WMCashToCardResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCashToCardResponse")
     ...
     */
    @WebMethod(operationName = "WMCardRestore", action = "https://SistemasGalileo.com/Services/WMCardRestore")
    @WebResult(name = "WMCardRestoreResult", targetNamespace = "https://SistemasGalileo.com/Services/")
    @RequestWrapper(localName = "WMCardRestore", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardRestore")
    @ResponseWrapper(localName = "WMCardRestoreResponse", targetNamespace = "https://SistemasGalileo.com/Services/", className = "com.smartbt.vtsuite.connection.WMCardRestoreResponse")
