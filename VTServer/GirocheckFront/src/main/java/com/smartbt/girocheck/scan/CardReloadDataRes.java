...
@XmlType( name = "CardReloadDataRes", propOrder = {
    "checkId",
    "resultCode",
    "resultMessage"
} )
public class CardReloadDataRes extends MainResponseContainer implements IBuilder {
    ...
    @Override
    public CardReloadDataRes build( Map map ) throws Exception {
