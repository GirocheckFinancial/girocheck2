...
@XmlType(name = "cardReloadDataResponse", propOrder = {
    "_return"
})
public class CardReloadDataResponse {

    @XmlElement(name = "return")
    protected CardReloadDataRes _return;
     ...
     *     
     */
    public CardReloadDataRes getReturn() {
        return _return;
    }
     ...
     *     
     */
    public void setReturn(CardReloadDataRes value) {
        this._return = value;
    }
