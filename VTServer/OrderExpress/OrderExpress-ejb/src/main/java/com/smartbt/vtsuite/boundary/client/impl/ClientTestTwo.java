...
//        //input.setDATETIME( OEUtils.singleQuote( OrderExpressConstantValues.DATE_TIME ) );
...
//
//            response.setContratacionesResult( port.contrataciones( encoded, OrderExpressConstantValues.DATOS, OrderExpressConstantValues.CORRESPONSALES, OrderExpressConstantValues.RUTAEJECUTAR ) );
//
