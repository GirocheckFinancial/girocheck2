 ...
 * 
 */
@WebServiceClient(name = "PCAService", targetNamespace = "http://fis.certegy.pca.com/", wsdlLocation = "file:/C:/Glassfish/certegy_wsdl/secondary/certegypca.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Glassfish/certegy_wsdl/secondary/certegypca.wsdl");
