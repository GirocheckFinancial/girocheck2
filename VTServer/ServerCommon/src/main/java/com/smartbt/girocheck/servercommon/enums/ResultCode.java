...
public enum ResultCode {
    ...
    IDEOLOGY_HOST_ERROR(650),
    IDEOLOGY_HOST_RECEIVED_NULL(651),
    IDEOLOGY_HOST_UNEXPECTED_RESULT_CODE(652),
    IDEOLOGY_RESPONSE_TIME_EXCEEDED(653),
    IDEOLOGY_HOST_RETURN_PROCESSING_FALSE(654),
