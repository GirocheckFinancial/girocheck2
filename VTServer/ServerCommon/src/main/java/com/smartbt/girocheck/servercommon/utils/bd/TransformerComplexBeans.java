/*
 ** File: TransformerComplexBeans.java
 **
 ...
 * @author samiandoni
 */
public class TransformerComplexBeans extends AliasedTupleSubsetResultTransformer {

    protected static final Logger log = Logger.getLogger(TransformerComplexBeans.class);
    ...
    public TransformerComplexBeans(Class<?> resultClass) {
